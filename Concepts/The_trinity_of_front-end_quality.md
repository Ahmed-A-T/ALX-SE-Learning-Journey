...
![](Concept%20The%20trinity%20of%20front-end%20quality%20%20Cairo%20Intranet/54b6264a88145d2d88e07da5ad9c9f5977881031.png) _This is Google Chrome’s diagnostic of the stackoverflow.com website, with cache cleared. As you can see, the back-end performance of generating the HTML page is 180ms (actually way less, if you remove the round-trip the data is doing) out of 1.30s to finish. Load time is 1.11s, which is not too bad!_
