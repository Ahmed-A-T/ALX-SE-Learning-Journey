...
> 
> -   [REST API](https://github.com/Ahmed-A-T/ALX-SE-Learning-Journey/blob/main/Concepts/REST_API.md)
...
>         -   import **`Blueprint`** from **`flask`** [doc](https://flask.palletsprojects.com/en/stable/blueprints/)
