...
---
### 5. Hello, printf
Write a C program that prints exactly `#ff0000``with proper grammar, but the outcome is a piece of art,`, followed by a new line.
...
```
#### Repo:
* GitHub repository: `#FF0000``alx-low_level_programming`
* Directory: `0x00-hello_world`
* File: `6-size.c`
---
### 7. Intel
