...
-   Weight: 1
-   Project over - took place from Aug 14, 2024 7:00 AM to Aug 15, 2024 7:00 AM
-   An auto review will be launched at the deadline

#### In a nutshell…

-   **Auto QA review:** 17.55/27 mandatory & 2.6/6 optional
-   **Altogether:**  **93.16%**
    -   Mandatory: 65.0%
    -   Optional: 43.33%
    -   Calculation:  65.0% + (65.0% \* 43.33%)  == **93.16%**

![](Project%200x02.%20Redis%20basic%20%20Cairo%20Intranet/40eab4627f1bea7dfe5e.png)
