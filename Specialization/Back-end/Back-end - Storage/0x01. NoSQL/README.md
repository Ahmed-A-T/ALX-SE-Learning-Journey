...
>         -   **`path=/status`**
> 
> You can use this dump as data sample: [dump.zip](https://github.com/Ahmed-A-T/ALX-SE-Learning-Journey/blob/main/Specialization/Back-end/Back-end%20-%20Storage/0x01.%20NoSQL/assets/dump.zip "dump.zip")
> 
