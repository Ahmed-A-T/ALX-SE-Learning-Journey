...
-   Weight: 1
-   Project over - took place from Aug 22, 2024 7:00 AM to Aug 27, 2024 7:00 AM

![](Project%200x02.%20React%20props%20%20Cairo%20Intranet/cd505f5320193e7f187e.jpeg)
...
-   [React Fragments](https://intranet.alxswe.com/rltoken/AnYmWGZ8hVMZ0sE8pjQoEg "React Fragments")
...
![](Project%200x02.%20React%20props%20%20Cairo%20Intranet/93fff44934f1b3731814.png)

-   Modify the CSS to make the UI looks like the image below when `displayDrawer` is `false`

![](Project%200x02.%20React%20props%20%20Cairo%20Intranet/de6ede8a7a0f95acc03d.png)

App:

-   Modify the CSS to make the UI looks like the image below when `isLoggedIn` is `false`

![](Project%200x02.%20React%20props%20%20Cairo%20Intranet/ea8018d0358b054bfa1f.png)

-   Modify the CSS to make the UI looks like the image below when `isLoggedIn` is `true`

![](Project%200x02.%20React%20props%20%20Cairo%20Intranet/de6b8b4a26ee79920a92.png)
