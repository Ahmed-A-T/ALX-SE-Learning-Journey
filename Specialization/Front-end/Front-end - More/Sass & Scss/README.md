...
## **Read or watch**:
> -   [Sass Basics](https://sass-lang.com/guide/ "Sass Basics")
> -   [Sass flow control directives: @if, @for, @each and @while](https://sass-lang.com/documentation/at-rules/control/ "Sass flow control directives: @if, @for, @each and @while")
> -   [Sass references](https://sass-lang.com/documentation/ "Sass references")
