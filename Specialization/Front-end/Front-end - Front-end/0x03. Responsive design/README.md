...
Or some basics assets from this [archive.zip](./assets/archive.zip "archive.zip")
...
> **Wide screen:**
> 
> ![](./assets/00x003-04.png)
> 
> **Narrow screen:**
> 
> ![](./assets/00x003-05.png)
...
## 2\. Fix layout issues
> Whatever the browser you use, it’s a good idea from now on, to [toggle the device view](https://developer.chrome.com/docs/devtools/ "toggle the device view").
> 
...
> 
> ![](./assets/00x003-06.png)
> 
> **Rendering on screen with max-width: 767px**
> 
> ![](./assets/00x003-07.png)
> 
