...
-   Project over - took place from May 31, 2024 7:00 AM to Jun 7, 2024 7:00 AM
-   Manual QA review was done on Jun 7, 2024 1:44 AM

#### In a nutshell…

-   **Manual QA review:** 11.0/11 mandatory
-   **Altogether:**  **100.0%**
    -   Mandatory: 100.0%
...
![](Project%20Research%20&%20Project%20approval%20(Part%202)%20%20Cairo%20Intranet/7c257c6a8cd537400e72.png)
...
1.  [https://docs.google.com/document/d/1y5\_Y8wbjx7s8vAyNdxLfJRPyaXf\_RJWSd\_v4rfCLEvI/edit?usp=sharing](https://docs.google.com/document/d/1y5_Y8wbjx7s8vAyNdxLfJRPyaXf_RJWSd_v4rfCLEvI/edit?usp=sharing) Remove
...
-   [Web Architecture 101](https://intranet.alxswe.com/rltoken/-jOY1yTSoVvysinRHQPrwQ "Web Architecture 101")
-   [List of tools to create architecture diagrams](https://intranet.alxswe.com/rltoken/StImfq84BUH3A4wnmjqMLw "List of tools to create architecture diagrams")
-   [Web Application Architecture](https://intranet.alxswe.com/rltoken/TmbJuwX1d6XsSd2Ppr6pSg "Web Application Architecture")
...
Tools: [SqlDBM](https://intranet.alxswe.com/rltoken/6NDhFhDLlvGnO5IQPjNxsA "SqlDBM")

Example: ![](Project%20Research%20&%20Project%20approval%20(Part%202)%20%20Cairo%20Intranet/83eed8d2d8a6b390f16f.gif)
...
First, research what [user stories](https://intranet.alxswe.com/rltoken/MP_p24nJnvQxErkP0IpZtA "user stories") are, and how to write them. Also note [some pitfalls](https://intranet.alxswe.com/rltoken/FLr9JQQFgm0zz3ZEfqKCwA "some pitfalls") of creating user stories that are too general.
...
![](Project%20Research%20&%20Project%20approval%20(Part%202)%20%20Cairo%20Intranet/f7f084b4bf401c4a94fd.png)

If there is any visual interface to your Portfolio Project, this section is required. If your project lives on the commandline, or in script, then do not include this section. Use a prototyping tool, like [Balsamiq](https://intranet.alxswe.com/rltoken/gr0KAmc8Pgs7IMawbJtlIQ "Balsamiq"), to draft your user-facing visual interfaces.
