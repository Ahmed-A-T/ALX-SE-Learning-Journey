...
![](Project%200x0D.%20Web%20stack%20debugging%200%20%20Cairo%20Intranet/uWLzjc8.jpg)
...
-   [Mac OS](https://intranet.alxswe.com/rltoken/ZuaMHYN9UVI-wHOFVPdugA "Mac OS")
-   [Windows](https://intranet.alxswe.com/rltoken/XGbcJ5U3jnuNDLyDGOr_kg "Windows")
...
In this first debugging project, you will need to get [Apache](https://intranet.alxswe.com/rltoken/HVGgLL51qmuulmw802M-Jg "Apache") to run on the container and to return a page containing `Hello ALX` when querying the root of it.
